...
func (_c *WritableFile_Close_Call) RunAndReturn(run func() error) *WritableFile_Close_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFile_Read_Call) RunAndReturn(run func([]byte) (int, error)) *WritableFile_Read_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFile_Stat_Call) RunAndReturn(run func() (fs.FileInfo, error)) *WritableFile_Stat_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFile_Write_Call) RunAndReturn(run func([]byte) (int, error)) *WritableFile_Write_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewWritableFile(t interface {
	mock.TestingT
	Cleanup(func())
}) *WritableFile {
	mock := &WritableFile{}
