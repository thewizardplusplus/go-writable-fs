...
func (_c *WritableFS_Create_Call) RunAndReturn(run func(string) (writablefs.WritableFile, error)) *WritableFS_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFS_CreateExcl_Call) RunAndReturn(run func(string) (writablefs.WritableFile, error)) *WritableFS_CreateExcl_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFS_Mkdir_Call) RunAndReturn(run func(string, fs.FileMode) error) *WritableFS_Mkdir_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFS_Open_Call) RunAndReturn(run func(string) (fs.File, error)) *WritableFS_Open_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFS_Remove_Call) RunAndReturn(run func(string) error) *WritableFS_Remove_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *WritableFS_Rename_Call) RunAndReturn(run func(string, string) error) *WritableFS_Rename_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewWritableFS(t interface {
	mock.TestingT
	Cleanup(func())
}) *WritableFS {
	mock := &WritableFS{}
